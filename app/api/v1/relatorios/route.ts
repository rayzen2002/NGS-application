...
export async function POST(request: Request) {
  ...
  try {
    ...
    const newRelatorios: RelatoriosResponse = relatoriosDataInputArray.map((item: Relatorio) => ({
      ...
      started_at: dayjs.tz(item.started_at, "DD/MM/YYYY HH:mm", "America/Sao_Paulo").toDate(),
      finished_at: dayjs.tz(item.finished_at, "DD/MM/YYYY HH:mm", "America/Sao_Paulo").toDate(),
